...
//#endif
    ...
    IMGUI_API bool          DefaultBeginChildEx(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags);
    ...
    IMGUI_API bool          Tab(const char* label, ImTextureID icon, bool active, const char* override_id = "");
