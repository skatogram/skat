...
namespace KeyAuth {
	...
	public:
		...
		void get_text(const char* url, std::string& value);
		void upgrade(std::string username, std::string key);
		void get_updatelog(std::string& value, std::string& timestamp);
		void login(std::string username, std::string password);
		void token_login(std::string username, std::string token);
