namespace O {
	...
	namespace BasePlayer {
		constexpr auto __menuOption_Climb = 0x248;
		constexpr auto __menuOption_Drink = 0x2a8;
		constexpr auto __menuOption_InviteToTeam = 0x308;
		constexpr auto __menuOption_Menu_AssistPlayer = 0x368;
		constexpr auto __menuOption_Menu_LootPlayer = 0x3c8;
		constexpr auto __menuOption_Promote = 0x428;
		constexpr auto __menuOption_SaltWater = 0x488;
		constexpr auto playerModel = 0x4e8;
		constexpr auto Frozen = 0x4f0;
		constexpr auto voiceRecorder = 0x4f8;
		constexpr auto voiceSpeaker = 0x500;
		constexpr auto input = 0x508;
		constexpr auto movement = 0x510;
		constexpr auto collision = 0x518;
		constexpr auto _lookingAt = 0x520;
		constexpr auto _lookingAtEntity = 0x528;
		constexpr auto _lookingAtCollider = 0x530;
		constexpr auto lookingAtPointk__BackingField = 0x538;
		constexpr auto wakeTime = 0x544;
		constexpr auto needsClothesRebuild = 0x548;
		constexpr auto wasSleeping = 0x549;
		constexpr auto wokeUpBefore = 0x54a;
		constexpr auto wasDead = 0x54b;
		constexpr auto lastClothesHash = 0x54c;
		constexpr auto visiblePlayerList = 0x8;
		constexpr auto craftMode = 0x10;
		constexpr auto lootPanelOverride = 0x18;
		constexpr auto lastOpenSoundPlay = 0x550;
		constexpr auto currentViewMode = 0x554;
		constexpr auto selectedViewMode = 0x558;
		constexpr auto lastRevivePoint = 0x55c;
		constexpr auto lastReviveDirection = 0x568;
		constexpr auto IsWearingDiveGogglesk__BackingField = 0x574;
		constexpr auto GestureViewModel = 0x578;
		constexpr auto timeSinceUpdatedLookingAt = 0x580;
		constexpr auto nextTopologyTestTime = 0x584;
		constexpr auto usePressTime = 0x588;
		constexpr auto useHeldTime = 0x58c;
		constexpr auto lookingAtTest = 0x590;
		constexpr auto lastDeathTimeClient = 0x20;
		constexpr auto cachedWaterDrinkingPoint = 0x598;
		constexpr auto gestureList = 0x5a8;
		constexpr auto gestureFinishedTime = 0x5b0;
		constexpr auto blockHeldInputTimer = 0x5b4;
		constexpr auto currentGesture = 0x5b8;
		constexpr auto disabledHeldEntity = 0x5c0;
		constexpr auto nextGestureMenuOpenTime = 0x5c8;
		constexpr auto lastGestureCancel = 0x5cc;
		constexpr auto client_lastHelloTime = 0x5d0;
		constexpr auto currentTeam = 0x5d8;
		constexpr auto MaxTeamSizeToast = 0x28;
		constexpr auto clientTeam = 0x5e0;
		constexpr auto lastReceivedTeamTime = 0x5e8;
		constexpr auto lastPresenceTeamId = 0x5f0;
		constexpr auto lastPresenceTeamSize = 0x5f8;
		constexpr auto playerGroupKey = 0x600;
		constexpr auto playerGroupSizeKey = 0x608;
		constexpr auto clActiveItem = 0x610;
		constexpr auto MarkerLimitPhrase = 0x30;
		constexpr auto ClientCurrentMapNotes = 0x618;
		constexpr auto ClientCurrentDeathNote = 0x620;
		constexpr auto keepOpenMapInterface = 0x628;
		constexpr auto missions = 0x630;
		constexpr auto _activeMission = 0x638;
		constexpr auto modelState = 0x640;
		constexpr auto mounted = 0x648;
		constexpr auto nextSeatSwapTime = 0x658;
		constexpr auto PetEntity = 0x660;
		constexpr auto lastPetCommandIssuedTime = 0x668;
		constexpr auto PetPrefabID = 0x66c;
		constexpr auto PetID = 0x670;
		...
		constexpr auto ClientCurrentPings = 0x678;
		constexpr auto tapInProcess = 0x680;
		constexpr auto lastPingTap = 0x684;
		constexpr auto cachedBuildingPrivilegeTime = 0x688;
		constexpr auto cachedBuildingPrivilege = 0x690;
		constexpr auto maxProjectileID = 0x698;
		constexpr auto lastUpdateTime = 0x69c;
		constexpr auto cachedThreatLevel = 0x6a0;
		constexpr auto serverTickRate = 0x6a4;
		constexpr auto clientTickRate = 0x6a8;
		constexpr auto serverTickInterval = 0x6ac;
		constexpr auto clientTickInterval = 0x6b0;
		constexpr auto lastSentTickTime = 0x6b4;
		constexpr auto lastTickStopwatch = 0x6b8;
		constexpr auto lastSentTick = 0x6c0;
		constexpr auto nextVisThink = 0x6c8;
		constexpr auto lastTimeSeen = 0x6cc;
		constexpr auto debugPrevVisible = 0x6d0;
		constexpr auto fallDamageEffect = 0x6d8;
		constexpr auto drownEffect = 0x6e0;
		constexpr auto playerFlags = 0x6e8;
		constexpr auto eyes = 0x6f0;
		constexpr auto inventory = 0x6f8;
		constexpr auto blueprints = 0x700;
		constexpr auto metabolism = 0x708;
		constexpr auto modifiers = 0x710;
		constexpr auto playerCollider = 0x718;
		constexpr auto Belt = 0x720;
		constexpr auto playerRigidbody = 0x728;
		constexpr auto userID = 0x730;
		constexpr auto UserIDString = 0x738;
		constexpr auto gamemodeteam = 0x740;
		constexpr auto reputation = 0x744;
		constexpr auto _displayName = 0x748;
		constexpr auto _lastSetName = 0x750;
		constexpr auto playerColliderStanding = 0x758;
		constexpr auto playerColliderDucked = 0x76c;
		constexpr auto playerColliderCrawling = 0x780;
		constexpr auto playerColliderLyingDown = 0x794;
		constexpr auto cachedProtection = 0x7a8;
		constexpr auto oldCameraFix = 0x168;
		constexpr auto lastHeadshotSoundTime = 0x7b0;
		constexpr auto nextColliderRefreshTime = 0x7b4;
		constexpr auto clothingBlocksAiming = 0x7b8;
		constexpr auto clothingMoveSpeedReduction = 0x7bc;
		constexpr auto clothingWaterSpeedBonus = 0x7c0;
		constexpr auto clothingAccuracyBonus = 0x7c4;
		constexpr auto equippingBlocked = 0x7c8;
		constexpr auto eggVision = 0x7cc;
		constexpr auto activeTelephone = 0x7d0;
		constexpr auto designingAIEntity = 0x7d8;
	...
	namespace UnityEngine_GUIStyle {
		...
		namespace Door {
			constexpr auto __menuOption_Menu_CloseDoor = 0x278;
			constexpr auto __menuOption_Menu_KnockDoor = 0x2d8;
			constexpr auto __menuOption_Menu_OpenDoor = 0x338;
			constexpr auto __menuOption_Menu_ToggleHatch = 0x398;
			constexpr auto knockEffect = 0x3f8;
			constexpr auto canTakeLock = 0x400;
			constexpr auto hasHatch = 0x401;
			constexpr auto canTakeCloser = 0x402;
			constexpr auto canTakeKnocker = 0x403;
			constexpr auto canNpcOpen = 0x404;
			constexpr auto canHandOpen = 0x405;
			constexpr auto isSecurityDoor = 0x406;
			constexpr auto vehiclePhysBoxes = 0x408;
			constexpr auto checkPhysBoxesOnOpen = 0x410;
			constexpr auto vehicleCollisionSfx = 0x418;
			constexpr auto ClosedColliderRoots = 0x420;
			constexpr auto openAnimLength = 0x428;
			constexpr auto closeAnimLength = 0x42c;
		...
		namespace Item {
			...
			constexpr auto amountOverride = 0xb0;
		...
		namespace BaseCombatEntity {
			...
			constexpr auto skeletonProperties = 0x1c8;
			constexpr auto baseProtection = 0x1d0;
			constexpr auto startHealth = 0x1d8;
			constexpr auto pickup = 0x1e0;
			constexpr auto repair = 0x200;
			constexpr auto ShowHealthInfo = 0x228;
			constexpr auto lifestate = 0x22c;
			constexpr auto sendsHitNotification = 0x230;
			constexpr auto sendsMeleeHitNotification = 0x231;
			constexpr auto markAttackerHostile = 0x232;
			constexpr auto _health = 0x234;
			constexpr auto _maxHealth = 0x238;
			constexpr auto faction = 0x23c;
			constexpr auto deathTime = 0x240;
			constexpr auto lastNotifyFrame = 0x244;
		...
		namespace BaseMountable {
			constexpr auto __menuOption_Menu_Mount = 0x248;
			constexpr auto eyePositionOverride = 0x2a8;
			constexpr auto eyeCenterOverride = 0x2b0;
			constexpr auto pitchClamp = 0x2b8;
			constexpr auto yawClamp = 0x2c0;
			constexpr auto canWieldItems = 0x2c8;
			constexpr auto relativeViewAngles = 0x2c9;
			constexpr auto mountAnchor = 0x2d0;
			constexpr auto mountLOSVertOffset = 0x2d8;
			constexpr auto mountPose = 0x2dc;
			constexpr auto maxMountDistance = 0x2e0;
			constexpr auto dismountPositions = 0x2e8;
			constexpr auto checkPlayerLosOnMount = 0x2f0;
			constexpr auto disableMeshCullingForPlayers = 0x2f1;
			constexpr auto allowHeadLook = 0x2f2;
			constexpr auto ignoreVehicleParent = 0x2f3;
			constexpr auto legacyDismount = 0x2f4;
			constexpr auto modifiesPlayerCollider = 0x2f5;
			constexpr auto customPlayerCollider = 0x2f8;
			constexpr auto mountSoundDef = 0x310;
			constexpr auto swapSoundDef = 0x318;
			constexpr auto dismountSoundDef = 0x320;
			constexpr auto mountTimeStatType = 0x328;
			constexpr auto allowedGestures = 0x32c;
			constexpr auto canDrinkWhileMounted = 0x330;
			constexpr auto allowSleeperMounting = 0x331;
			constexpr auto animateClothInLocalSpace = 0x332;
			constexpr auto MountedCameraMode = 0x334;
			constexpr auto isMobile = 0x338;
			constexpr auto SideLeanAmount = 0x33c;
		...
		namespace BaseHelicopter {
			...
			constexpr auto weakspots = 0x3c8;
	...
	namespace CO
	{
		constexpr auto IsDucked = 0x77B400; // BasePlayer IsDucked
		constexpr auto GetGameObjectComponent = 0x25477E0; //+ Dumper::GetMethodOffset("UnityEngine.CoreModule", "UnityEngine", "GameObject", "GetComponent", 1)))(pointer, type);
		constexpr auto GUIDToObject = 0x8EF510; //+ Dumper::GetMethodOffset("Assembly-CSharp", "", "GameManifest", "GUIDToObject", 1)))(guid);
		// script.json
		constexpr auto TodSky = 49772896; // TOD_Sky_c* || TOD_Sky_TypeInfo
	}